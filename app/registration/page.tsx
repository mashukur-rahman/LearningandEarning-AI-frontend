        ...
        <div className="w-full max-w-md">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-md shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <p className="mb-8 text-gray-400">Sign up to get started</p>
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      <input
                        ...
                        className="sr-only"
                      />
                      <span className="text-base font-semibold text-white">Buyer</span>
                      <span className="mt-1 text-xs text-gray-400">Hire talents</span>
                    </label>
                    <label
                      className={`relative flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 p-4 transition-all ${
                    ...
                    >
                      <input
                        ...
                        className="sr-only"
                      />
                      <span className="text-base font-semibold text-white">Seller</span>
                      <span className="mt-1 text-xs text-gray-400">Get hired</span>
                    </label>
                  </div>
                </div>
                ...
                {/* Date of Birth Input */}
                <div>
                  <label htmlFor="dateOfBirth" className="mb-2 block text-sm font-medium text-white/80">
                    Date of Birth
                  </label>
                  <input
                    type="date"
                    ...
                    name="dateOfBirth"
                    required
                    className="w-full rounded-lg border border-white/20 bg-white/5 px-4 py-3 text-white placeholder-gray-500 backdrop-blur-sm transition-colors focus:border-white/40 focus:bg-white/10 focus:outline-none [color-scheme:dark]"
